      ...
      <div class="hero-content">
        <div class="avatar-wrapper">
          ...
          <div class="avatar-container">
            <svg v-if="!userInfo.avatar" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="avatar-icon">
        ...
        <div class="info-card" :class="{ editing: isEditing }">
          <div class="card-header">
            ...
            <button class="edit-btn" @click="toggleEdit">
              <svg v-if="!isEditing" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
