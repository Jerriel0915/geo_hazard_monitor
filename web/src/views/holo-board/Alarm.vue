    ...
    <div class="alarm-header">
      ...
      <div class="header-center">
        <div class="header-title">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="#f5222d" stroke-width="2"
               width="20" height="20">
            <path d="M18 8A6 6 0 0 0 6 8c0 7-3 9-3 9h18s-3-2-3-9"/>
            <path d="M13.73 21a2 2 0 0 1-3.46 0"/>
          </svg>
          ...
          <div class="panel-body">
            <table class="alarm-table">
              ...
              <tr v-for="alarm in alarmList" :key="alarm.id">
                ...
                <td><span :class="['response-badge', alarm.responded ? 'yes' : 'no']">{{
                    alarm.responded ? '已响应' : '未响应'
                  }}</span></td>
              </tr>
              </tbody>
            </table>
        ...
        <div class="panel pie-chart-panel">
          ...
          <div class="panel-body">
            ...
            <div class="pie-legend">
              ...
              <div class="legend-item"><span class="legend-dot orange"></span><span>橙色 {{ alarmStats.orange }}</span>
              </div>
              <div class="legend-item"><span class="legend-dot yellow"></span><span>黄色 {{ alarmStats.yellow }}</span>
              </div>
              <div class="legend-item"><span class="legend-dot blue"></span><span>蓝色 {{ alarmStats.blue }}</span>
              </div>
            </div>
          </div>
        </div>
