        ...
        <div class="group-list" @scroll="handleGroupListScroll">
          ...
          >
            ...
            <div class="group-actions">
              ...
              <span class="action-btn delete-btn" @click.stop="handleDeleteGroup(group)"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" width="11" height="11"><line x1="18" y1="6" x2="6" y2="18"/><line x1="6" y1="6" x2="18" y2="18"/></svg></span>
            </div>
          </div>
  ...
  <el-button @click="handleRefresh" :loading="refreshing">刷新</el-button>
                  ...
                  <el-option v-for="g in groupOptions" :key="g.id" :value="g.id" :label="g.name">
                    <div style="display: flex; justify-content: space-between; align-items: center; width: 100%;">
                      ...
                      <span v-if="g.id !== '1'" style="display: flex; gap: 5px;">
                        <span class="group-action-btn" @click.stop="handleEditGroupFromSelect(g)" title="修改"><el-icon :size="14"><Edit /></el-icon></span>
                        <span class="group-action-btn delete-btn" @click.stop="handleDeleteGroupFromSelect(g)" title="删除"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" width="14" height="14"><line x1="18" y1="6" x2="6" y2="18"/><line x1="6" y1="6" x2="18" y2="18"/></svg></span>
                      </span>
                    </div>
                  </el-option>
                </el-select>
    ...
    >
      ...
      <div class="map-actions">
        <el-button-group>
          <el-button type="primary" size="small" @click="setDrawMode('point')"><el-icon><Location /></el-icon> 设置中心点</el-button>
          <el-button size="small" @click="setDrawMode('polygon')"><el-icon><Edit /></el-icon> 绘制范围</el-button>
          <el-button size="small" @click="setDrawMode('strike')"><el-icon><DArrowRight /></el-icon> 绘制走向</el-button>
          <el-button size="small" @click="clearDraw"><el-icon><Delete /></el-icon> 清除</el-button>
        </el-button-group>
      </div>
      <div class="map-info">
