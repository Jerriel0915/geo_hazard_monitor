...
export function getTopNotices(pageNum = 1, pageSize = 10, status = '0'): Promise<TopNoticeResponse> {
  return request.get('/system/notice/listTop', { params: { pageNum, pageSize, status } })
}
