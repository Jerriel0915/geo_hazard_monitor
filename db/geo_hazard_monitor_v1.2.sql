...
VALUES (1, 'HP001', '隐患点A修改', 2, '滑坡监测组', 104.156790, 30.678902, 50.00, '修改后的描述', 1, 3, 'admin',
        '2026-05-10 16:12:29', 'admin', '2026-05-21 17:47:23', 0),
       (2, 'HP002', '龙泉寺崩塌隐患点', 1, '崩塌监测组', 104.234567, 31.678901, 120.30,
        '龙泉寺后方岩质边坡，岩体破碎，存在崩塌风险，已安装裂缝计监测。', 1, 2, 'admin', '2026-05-10 16:12:29', NULL,
        '2026-05-10 16:12:29', 0),
       (3, 'HP003', '清溪乡泥石流隐患点', 2, '泥石流监测组', 104.345678, 31.789012, 0.00,
        '清溪乡沟谷型泥石流隐患点，汇水面积大，暴雨季节需重点关注。', 1, 4, 'admin', '2026-05-10 16:12:29', NULL,
        '2026-05-10 16:12:29', 0),
       (4, 'HP004', '工业园区地面沉降点', 2, '沉降监测组', 104.456789, 31.890123, 0.00,
        '工业园区由于地下水位下降导致地面沉降，需持续监测地面高程变化。', 1, 2, 'admin', '2026-05-10 16:12:29', NULL,
        '2026-05-10 16:12:29', 0),
       (5, 'HP005', '顺发铁矿边坡监测点', 5, '边坡监测组', 104.567890, 31.901234, 65.00,
        '顺发铁矿露天采场边坡，高度约120米，边坡角度55度，需重点监测位移变化。', 1, 5, 'admin', '2026-05-10 16:12:29', NULL,
        '2026-05-10 18:47:39', 0),
       (6, 'HP006', '古镇危岩治理点', 3, '危岩监测组', 104.678901, 32.012345, 200.00,
        '古镇后山危岩体，经治理后已稳定，现处于观测期。', 3, 1, 'admin', '2026-05-10 16:12:29', NULL,
        '2026-05-10 18:47:39', 0),
       (7, 'HP007', '新城基坑监测点', 2, '基坑监测组', 104.789012, 31.123456, 0.00,
        '新城建设基坑工程，因施工暂停监测，预计3个月后恢复。', 2, 0, 'admin', '2026-05-10 16:12:29', NULL,
        '2026-05-10 16:12:29', 0),
       (8, 'HP999', '我的测试', 2, NULL, 104.000000, 30.000000, 50.00, '测试', 1, 0, 'admin', '2026-05-10 17:04:51',
        'admin', '2026-05-10 17:19:33', 2),
       (9, 'HP9999', '测试', 2, NULL, 104.000000, 30.000000, 45.00, '测试', 1, 0, 'admin', '2026-05-10 17:20:23', NULL,
        '2026-05-10 17:39:50', 2),
       (11, 'HP888', '测试', 6, NULL, 104.060004, 30.670000, 6.00, 'haidhfaib', 1, 0, 'admin', '2026-05-10 17:35:51',
        'admin', '2026-05-10 17:39:27', 2),
       (12, 'HP777', '测试', 6, NULL, 104.060000, 30.670000, 7.00, '测试', 1, 0, 'admin', '2026-05-10 17:40:08',
        'admin', '2026-05-21 19:54:24', 2);
/*!40000 ALTER TABLE `hazard_point`
    ENABLE KEYS */;
UNLOCK TABLES;
...
VALUES (1, 'G001', '崩塌监测组', '崩塌地质灾害隐患点监测', 1, 1, 'admin', '2026-05-10 18:47:12', NULL,
       ...
       (5, 'G005', '边坡监测组', '边坡地质灾害隐患点监测', 5, 1, 'admin', '2026-05-10 18:47:12', NULL,
        '2026-05-10 18:47:12', 0),
       (6, 'G006', '地址测试', '地址测试', 10, 1, 'admin', '2026-05-10 18:47:12', 'admin', '2026-05-10 19:18:52', 0),
...
VALUES (1, 1, 'rainfall_hour', '小时雨量', 'mm', 'yl', NULL, 0, NULL, '2026-05-08 22:06:01', NULL,
        '2026-05-08 22:06:01', 0),
       (2, 1, 'rainfall_day', '日雨量', 'mm', 'yl', NULL, 0, NULL, '2026-05-08 22:06:01', NULL, '2026-05-08 22:06:01',
        0),
       (3, 2, 'displacement_x', 'X轴位移', 'mm', 'wy', NULL, 0, NULL, '2026-05-08 22:06:01', NULL,
        '2026-05-08 22:06:01', 0),
       (4, 2, 'displacement_y', 'Y轴位移', 'mm', 'wy', NULL, 0, NULL, '2026-05-08 22:06:01', NULL,
        '2026-05-08 22:06:01', 0),
       (5, 2, 'displacement_z', 'Z轴位移', 'mm', 'wy', NULL, 0, NULL, '2026-05-08 22:06:01', NULL,
        '2026-05-08 22:06:01', 0),
       (6, 3, 'temperature', '温度', '℃', 'wd', NULL, 0, NULL, '2026-05-08 22:06:01', NULL, '2026-05-08 22:06:01', 0),
       (7, 3, 'humidity', '含水率', '%', 'hsl', NULL, 0, NULL, '2026-05-08 22:06:01', NULL, '2026-05-08 22:06:01', 0),
       (8, 4, 'water_level', '水位', 'm', 'sw', NULL, 0, NULL, '2026-05-08 22:06:01', NULL, '2026-05-08 22:06:01', 0),
       (9, 5, 'crack_width', '裂缝宽度', 'mm', 'lf', NULL, 0, NULL, '2026-05-08 22:06:01', NULL, '2026-05-08 22:06:01',
        0),
       (10, 6, 'inclination_x', 'X方向倾角', '°', 'qx', NULL, 0, NULL, '2026-05-08 22:06:01', NULL,
        '2026-05-08 22:06:01', 0),
       (11, 6, 'inclination_y', 'Y方向倾角', '°', 'qx', NULL, 0, NULL, '2026-05-08 22:06:01', NULL,
        '2026-05-08 22:06:01', 0),
       (12, 7, 'soil_temp_10cm', '10cm地温', '℃', 'dw', NULL, 0, NULL, '2026-05-08 22:06:01', NULL,
        '2026-05-08 22:06:01', 0),
       (13, 8, 'soil_moisture', '土壤含水率', '%', 'hsl', NULL, 0, NULL, '2026-05-08 22:06:01', NULL,
        '2026-05-08 22:06:01', 0);
/*!40000 ALTER TABLE `monitor_content`
    ENABLE KEYS */;
UNLOCK TABLES;
...
VALUES (100, 0, '0', '若依科技', 0, '若依', '15888888888', 'ry@qq.com', '0', '0', 'admin', '2026-05-08 22:05:51', '',
        NULL),
       (101, 100, '0,100', '深圳总公司', 1, '若依', '15888888888', 'ry@qq.com', '0', '0', 'admin',
        '2026-05-08 22:05:51', '', NULL),
...
VALUES (100, 'admin', '127.0.0.1', '内网IP', 'Apifox 1.0.0', '', '0', '登录成功', '2026-05-08 22:16:02'),
       (101, 'admin', '127.0.0.1', '内网IP', 'Edge 147', 'Windows >=10', '1', '用户不存在/密码错误',
        '2026-05-09 19:54:34'),
       (102, 'admin', '127.0.0.1', '内网IP', 'Edge 147', 'Windows >=10', '0', '登录成功', '2026-05-09 19:54:54'),
       (103, 'admin', '127.0.0.1', '内网IP', 'Edge 147', 'Windows >=10', '0', '登录成功', '2026-05-09 20:23:58'),
       (104, 'admin', '127.0.0.1', '内网IP', 'Edge 147', 'Windows >=10', '0', '登录成功', '2026-05-09 20:24:07'),
       (105, 'admin', '127.0.0.1', '内网IP', 'Edge 147', 'Windows >=10', '0', '登录成功', '2026-05-09 20:24:36'),
       (106, 'admin', '127.0.0.1', '内网IP', 'Edge 147', 'Windows >=10', '1', '验证码已失效', '2026-05-09 20:37:49'),
       (107, 'admin', '127.0.0.1', '内网IP', 'Edge 147', 'Windows >=10', '0', '登录成功', '2026-05-09 20:38:04'),
       (108, 'zwei', '172.27.55.242', '内网IP', 'Chrome 147', 'Windows10', '1', '用户不存在/密码错误',
        '2026-05-10 15:34:27'),
       (109, 'zwei', '172.27.55.242', '内网IP', 'Chrome 147', 'Windows10', '1', '用户不存在/密码错误',
        '2026-05-10 15:34:27'),
       (110, 'admin', '172.27.55.242', '内网IP', 'Chrome 147', 'Windows10', '0', '登录成功', '2026-05-10 15:34:50'),
       (111, 'admin', '127.0.0.1', '内网IP', 'Edge 148', 'Windows >=10', '1', '验证码已失效', '2026-05-10 16:04:27'),
       (112, 'admin', '127.0.0.1', '内网IP', 'Edge 148', 'Windows >=10', '0', '登录成功', '2026-05-10 16:04:27'),
       (113, 'admin', '172.27.55.242', '内网IP', 'Apifox 1.0.0', '', '0', '登录成功', '2026-05-10 16:09:08'),
       (114, 'admin', '127.0.0.1', '内网IP', 'Edge 148', 'Windows >=10', '0', '登录成功', '2026-05-10 16:29:02'),
       (115, 'admin', '127.0.0.1', '内网IP', 'Edge 148', 'Windows >=10', '1', '验证码已失效', '2026-05-10 16:29:02'),
       (116, 'admin', '127.0.0.1', '内网IP', 'Edge 148', 'Windows >=10', '1', '验证码错误', '2026-05-10 16:29:06'),
       (117, 'admin', '127.0.0.1', '内网IP', 'Edge 148', 'Windows >=10', '0', '登录成功', '2026-05-10 16:29:44'),
       (118, 'admin', '127.0.0.1', '内网IP', 'Edge 148', 'Windows >=10', '0', '登录成功', '2026-05-10 16:29:58'),
       (119, 'admin', '127.0.0.1', '内网IP', 'Edge 148', 'Windows >=10', '0', '登录成功', '2026-05-10 16:30:22'),
       (120, 'admin', '127.0.0.1', '内网IP', 'Edge 148', 'Windows >=10', '1', '验证码已失效', '2026-05-10 16:32:14'),
       (121, 'admin', '127.0.0.1', '内网IP', 'Edge 148', 'Windows >=10', '0', '登录成功', '2026-05-10 16:32:14'),
       (122, 'admin', '172.27.55.242', '内网IP', 'Chrome 147', 'Windows10', '0', '登录成功', '2026-05-10 16:41:33'),
       (123, 'admin', '172.27.55.242', '内网IP', 'Chrome 147', 'Windows10', '1', '验证码已失效', '2026-05-10 16:41:33'),
       (124, 'admin', '172.27.55.242', '内网IP', 'Chrome 147', 'Windows10', '0', '登录成功', '2026-05-10 16:44:14'),
       (125, 'admin', '172.27.55.242', '内网IP', 'Chrome 147', 'Windows10', '0', '登录成功', '2026-05-10 17:57:02'),
       (126, 'admin', '172.27.55.242', '内网IP', 'Chrome 147', 'Windows10', '0', '登录成功', '2026-05-10 18:47:02'),
       (127, 'admin', '127.0.0.1', '内网IP', 'Edge 148', 'Windows >=10', '0', '登录成功', '2026-05-14 23:56:11'),
       (128, 'admin', '127.0.0.1', '内网IP', 'Apifox 1.0.0', '', '0', '登录成功', '2026-05-16 16:58:54'),
       (129, 'admin', '127.0.0.1', '内网IP', 'Apifox 1.0.0', '', '0', '登录成功', '2026-05-21 17:37:34'),
       (130, 'admin', '192.168.51.48', '内网IP', 'Chrome 148', 'Windows10', '1', '用户不存在/密码错误',
        '2026-05-21 19:45:09'),
       (131, 'admin', '192.168.51.48', '内网IP', 'Chrome 148', 'Windows10', '0', '登录成功', '2026-05-21 19:45:28'),
       (132, 'admin', '192.168.51.48', '内网IP', 'Apifox 1.0.0', '', '0', '登录成功', '2026-05-21 20:44:38'),
       (133, 'admin', '192.168.51.64', '内网IP', 'Chrome 148', 'Windows10', '0', '登录成功', '2026-05-22 10:01:09'),
       (134, 'admin', '192.168.51.64', '内网IP', 'Chrome 148', 'Windows10', '0', '登录成功', '2026-05-22 10:36:06'),
       (135, 'admin', '192.168.51.64', '内网IP', 'Apifox 1.0.0', '', '0', '登录成功', '2026-05-22 10:38:05'),
       (136, 'admin', '192.168.51.64', '内网IP', 'Chrome 148', 'Windows10', '0', '登录成功', '2026-05-22 11:41:53');
/*!40000 ALTER TABLE `sys_logininfor`
    ENABLE KEYS */;
UNLOCK TABLES;
...
VALUES (100, '隐患点管理', 1, 'com.zwei.iot.hazard_point.HazardPointController.add()', 'POST', 1, 'admin', '研发部门',
        '/api/v1/hazard-points', '172.27.55.242', '内网IP',
        ...
        '{\"msg\":\"操作成功\",\"code\":200,\"timestamp\":1778403891184}', 0, NULL, '2026-05-10 17:04:51', 83),
       (101, '隐患点管理', 1, 'com.zwei.iot.hazard_point.HazardPointController.add()', 'POST', 1, 'admin', '研发部门',
        '/api/v1/hazard-points', '172.27.55.242', '内网IP',
        '{\"code\":\"HP999\",\"description\":\"测试新增\",\"groupId\":1,\"latitude\":30.678901,\"longitude\":104.156789,\"name\":\"测试隐患点\",\"params\":{},\"strike\":45} ',
        '{\"msg\":\"新增隐患点失败，编号已存在\",\"code\":500,\"timestamp\":1778404103111}', 0, NULL,
        '2026-05-10 17:08:23', 19),
       (102, '隐患点管理', 2, 'com.zwei.iot.hazard_point.HazardPointController.edit()', 'PUT', 1, 'admin', '研发部门',
        '/api/v1/hazard-points/1', '172.27.55.242', '内网IP',
        '1 {\"description\":\"修改后的描述\",\"groupId\":2,\"id\":1,\"latitude\":30.678902,\"longitude\":104.15679,\"name\":\"隐患点A修改\",\"params\":{},\"strike\":50,\"updateBy\":\"admin\"} ',
        '{\"msg\":\"操作成功\",\"code\":200,\"timestamp\":1778404106332}', 0, NULL, '2026-05-10 17:08:26', 11),
       (103, '隐患点管理', 2, 'com.zwei.iot.hazard_point.HazardPointController.edit()', 'PUT', 1, 'admin', '研发部门',
        '/api/v1/hazard-points/8', '172.27.55.242', '内网IP',
        '8 {\"description\":\"测试\",\"groupId\":2,\"id\":8,\"latitude\":30,\"longitude\":104,\"name\":\"我的测试\",\"params\":{},\"strike\":50,\"updateBy\":\"admin\"} ',
        '{\"msg\":\"操作成功\",\"code\":200,\"timestamp\":1778404453337}', 0, NULL, '2026-05-10 17:14:13', 9),
       (104, '隐患点管理', 3, 'com.zwei.iot.hazard_point.HazardPointController.remove()', 'DELETE', 1, 'admin',
        '研发部门', '/api/v1/hazard-points/8', '172.27.55.242', '内网IP', '8 ',
        '{\"msg\":\"操作成功\",\"code\":200,\"timestamp\":1778404773495}', 0, NULL, '2026-05-10 17:19:33', 31),
       (105, '隐患点管理', 1, 'com.zwei.iot.hazard_point.HazardPointController.add()', 'POST', 1, 'admin', '研发部门',
        '/api/v1/hazard-points', '172.27.55.242', '内网IP',
        '{\"code\":\"HP9999\",\"createBy\":\"admin\",\"description\":\"测试\",\"groupId\":2,\"id\":9,\"latitude\":30,\"longitude\":104,\"name\":\"测试\",\"params\":{},\"status\":1,\"strike\":45} ',
        '{\"msg\":\"操作成功\",\"code\":200,\"timestamp\":1778404823181}', 0, NULL, '2026-05-10 17:20:23', 22),
       (106, '隐患点管理', 1, 'com.zwei.iot.hazard_point.HazardPointController.add()', 'POST', 1, 'admin', '研发部门',
        '/api/v1/hazard-points', '172.27.55.242', '内网IP',
        ...
        '2026-05-10 17:35:35', 227),
       (107, '隐患点管理', 1, 'com.zwei.iot.hazard_point.HazardPointController.add()', 'POST', 1, 'admin', '研发部门',
        '/api/v1/hazard-points', '172.27.55.242', '内网IP',
        ...
        '{\"msg\":\"操作成功\",\"code\":200,\"timestamp\":1778405751429}', 0, NULL, '2026-05-10 17:35:51', 46),
       (108, '隐患点管理', 2, 'com.zwei.iot.hazard_point.HazardPointController.edit()', 'PUT', 1, 'admin', '研发部门',
        '/api/v1/hazard-points/11', '172.27.55.242', '内网IP',
        '11 {\"description\":\"haidhfaib\",\"groupId\":5,\"id\":11,\"latitude\":30.67,\"longitude\":104.060004,\"name\":\"正式测试\",\"params\":{},\"strike\":7,\"updateBy\":\"admin\"} ',
        '{\"msg\":\"操作成功\",\"code\":200,\"timestamp\":1778405793607}', 0, NULL, '2026-05-10 17:36:33', 8),
       (109, '隐患点管理', 2, 'com.zwei.iot.hazard_point.HazardPointController.edit()', 'PUT', 1, 'admin', '研发部门',
        '/api/v1/hazard-points/11', '172.27.55.242', '内网IP',
        '11 {\"description\":\"haidhfaib\",\"groupId\":6,\"id\":11,\"latitude\":30.67,\"longitude\":104.060004,\"name\":\"测试\",\"params\":{},\"strike\":6,\"updateBy\":\"admin\"} ',
        '{\"msg\":\"操作成功\",\"code\":200,\"timestamp\":1778405844144}', 0, NULL, '2026-05-10 17:37:24', 9),
       (110, '隐患点管理', 3, 'com.zwei.iot.hazard_point.HazardPointController.remove()', 'DELETE', 1, 'admin',
        '研发部门', '/api/v1/hazard-points/11', '172.27.55.242', '内网IP', '11 ',
        '{\"msg\":\"操作成功\",\"code\":200,\"timestamp\":1778405967298}', 0, NULL, '2026-05-10 17:39:27', 8),
       (111, '隐患点管理', 3, 'com.zwei.iot.hazard_point.HazardPointController.remove()', 'DELETE', 1, 'admin',
        '研发部门', '/api/v1/hazard-points/9', '172.27.55.242', '内网IP', '9 ',
        '{\"msg\":\"操作成功\",\"code\":200,\"timestamp\":1778405990192}', 0, NULL, '2026-05-10 17:39:50', 6),
       (112, '隐患点管理', 1, 'com.zwei.iot.hazard_point.HazardPointController.add()', 'POST', 1, 'admin', '研发部门',
        '/api/v1/hazard-points', '172.27.55.242', '内网IP',
        ...
        '{\"msg\":\"操作成功\",\"code\":200,\"timestamp\":1778406008221}', 0, NULL, '2026-05-10 17:40:08', 18),
       (113, '隐患点管理', 2, 'com.zwei.iot.controller.HazardPointController.edit()', 'PUT', 1, 'admin', '研发部门',
        '/api/v1/hazard-points/12', '172.27.55.242', '内网IP',
        '12 {\"description\":\"测试\",\"groupId\":4,\"id\":12,\"latitude\":30.67,\"longitude\":104.06,\"name\":\"测试\",\"params\":{},\"strike\":7,\"updateBy\":\"admin\"} ',
        '{\"msg\":\"操作成功\",\"code\":200,\"timestamp\":1778411120985}', 0, NULL, '2026-05-10 19:05:21', 54),
       (114, '隐患点管理', 2, 'com.zwei.iot.controller.HazardPointController.edit()', 'PUT', 1, 'admin', '研发部门',
        '/api/v1/hazard-points/12', '172.27.55.242', '内网IP',
        '12 {\"description\":\"测试\",\"groupId\":6,\"id\":12,\"latitude\":30.67,\"longitude\":104.06,\"name\":\"测试\",\"params\":{},\"strike\":7,\"updateBy\":\"admin\"} ',
        '{\"msg\":\"操作成功\",\"code\":200,\"timestamp\":1778411531139}', 0, NULL, '2026-05-10 19:12:11', 30),
       (115, '隐患点分组', 1, 'com.zwei.iot.controller.HazardPointGroupController.add()', 'POST', 1, 'admin',
        '研发部门', '/api/v1/hazard-point-groups', '172.27.55.242', '内网IP',
        '{\"code\":\"G009\",\"createBy\":\"admin\",\"description\":\"测试\",\"id\":7,\"name\":\"测试分组\",\"params\":{},\"sortOrder\":10,\"status\":1} ',
        '{\"msg\":\"操作成功\",\"code\":200,\"data\":7,\"timestamp\":1778411715806}', 0, NULL, '2026-05-10 19:15:15',
        23),
       (116, '隐患点分组', 2, 'com.zwei.iot.controller.HazardPointGroupController.edit()', 'PUT', 1, 'admin',
        '研发部门', '/api/v1/hazard-point-groups/6', '172.27.55.242', '内网IP',
        '6 {\"description\":\"地址测试\",\"id\":6,\"name\":\"地址测试\",\"params\":{},\"sortOrder\":10,\"status\":1,\"updateBy\":\"admin\"} ',
        '{\"msg\":\"操作成功\",\"code\":200,\"timestamp\":1778411932942}', 0, NULL, '2026-05-10 19:18:52', 23),
       (117, '隐患点分组', 3, 'com.zwei.iot.controller.HazardPointGroupController.remove()', 'DELETE', 1, 'admin',
        '研发部门', '/api/v1/hazard-point-groups/7', '172.27.55.242', '内网IP', '7 ',
        '{\"msg\":\"操作成功\",\"code\":200,\"timestamp\":1778411978765}', 0, NULL, '2026-05-10 19:19:38', 10),
       (118, '隐患点分组', 1, 'com.zwei.iot.controller.HazardPointGroupController.add()', 'POST', 1, 'admin',
        '研发部门', '/api/v1/hazard-point-groups', '172.27.55.242', '内网IP',
        '{\"code\":\"G1778412223257\",\"createBy\":\"admin\",\"description\":\"收缩不啊对吧\",\"id\":8,\"name\":\"测试\",\"params\":{},\"sortOrder\":4,\"status\":1} ',
        '{\"msg\":\"操作成功\",\"code\":200,\"data\":8,\"timestamp\":1778412229381}', 0, NULL, '2026-05-10 19:23:49',
        11),
       (119, '隐患点分组', 2, 'com.zwei.iot.controller.HazardPointGroupController.edit()', 'PUT', 1, 'admin',
        '研发部门', '/api/v1/hazard-point-groups/8', '172.27.55.242', '内网IP',
        '8 {\"description\":\"收缩不啊对吧\",\"id\":8,\"name\":\"测试\",\"params\":{},\"sortOrder\":4,\"status\":1,\"updateBy\":\"admin\"} ',
        '{\"msg\":\"操作成功\",\"code\":200,\"timestamp\":1778412366783}', 0, NULL, '2026-05-10 19:26:06', 43),
       (120, '隐患点分组', 3, 'com.zwei.iot.controller.HazardPointGroupController.remove()', 'DELETE', 1, 'admin',
        '研发部门', '/api/v1/hazard-point-groups/8', '172.27.55.242', '内网IP', '8 ',
        '{\"msg\":\"操作成功\",\"code\":200,\"timestamp\":1778412373000}', 0, NULL, '2026-05-10 19:26:13', 14),
       (121, '隐患点管理', 2, 'com.zwei.iot.controller.HazardPointController.batchOperate()', 'PUT', 1, 'admin',
        '研发部门', '/api/v1/hazard-points/batch/operate', '127.0.0.1', '内网IP',
        '{\"ids\":[12],\"operation\":\"pause\"} ', NULL, 1,
        ...
        '2026-05-15 00:13:37', 36),
       (122, '隐患点管理', 2, 'com.zwei.iot.controller.HazardPointController.batchOperate()', 'PUT', 1, 'admin',
        '研发部门', '/api/v1/hazard-points/batch/operate', '127.0.0.1', '内网IP',
        '{\"ids\":[12],\"operation\":\"pause\"} ', NULL, 1,
        ...
        '2026-05-15 00:16:43', 27),
       (123, '隐患点管理', 2, 'com.zwei.iot.controller.HazardPointController.batchOperate()', 'PUT', 1, 'admin',
        '研发部门', '/api/v1/hazard-points/batch/operate', '127.0.0.1', '内网IP',
        '{\"ids\":[12],\"operation\":\"pause\"} ', '{\"msg\":\"操作成功\",\"code\":200,\"timestamp\":1778775519293}', 0,
        NULL, '2026-05-15 00:18:39', 61),
       (124, '隐患点管理', 2, 'com.zwei.iot.controller.HazardPointController.batchOperate()', 'PUT', 1, 'admin',
        '研发部门', '/api/v1/hazard-points/batch/operate', '127.0.0.1', '内网IP',
        '{\"ids\":[12],\"operation\":\"resume\"} ', '{\"msg\":\"操作成功\",\"code\":200,\"timestamp\":1778775527352}',
        0, NULL, '2026-05-15 00:18:47', 9),
       (125, '隐患点管理', 2, 'com.zwei.iot.hazardpoint.controller.HazardPointController.pause()', 'PUT', 1, 'admin',
        '研发部门', '/api/v1/hazard-points/1/pause', '127.0.0.1', '内网IP', '1 true ',
        '{\"msg\":\"操作成功\",\"code\":200,\"timestamp\":1779356674255}', 0, NULL, '2026-05-21 17:44:34', 142),
       (126, '隐患点管理', 2, 'com.zwei.iot.hazardpoint.controller.HazardPointController.pause()', 'PUT', 1, 'admin',
        '研发部门', '/api/v1/hazard-points/1/pause', '127.0.0.1', '内网IP', '1 true ',
        '{\"msg\":\"操作成功\",\"code\":200,\"timestamp\":1779356780855}', 0, NULL, '2026-05-21 17:46:20', 13),
       (127, '隐患点管理', 2, 'com.zwei.iot.hazardpoint.controller.HazardPointController.pause()', 'PUT', 1, 'admin',
        '研发部门', '/api/v1/hazard-points/1/pause', '127.0.0.1', '内网IP', '1 false ',
        '{\"msg\":\"操作成功\",\"code\":200,\"timestamp\":1779356843919}', 0, NULL, '2026-05-21 17:47:23', 10),
       (128, '隐患点管理', 1, 'com.zwei.iot.hazardpoint.controller.HazardPointController.add()', 'POST', 1, 'admin',
        '研发部门', '/api/v1/hazard-points', '192.168.51.48', '内网IP',
        ...
        '2026-05-21 19:50:41', 266),
       (129, '隐患点管理', 1, 'com.zwei.iot.hazardpoint.controller.HazardPointController.add()', 'POST', 1, 'admin',
        '研发部门', '/api/v1/hazard-points', '192.168.51.48', '内网IP',
        '{\"code\":\"HP23165\",\"description\":\"测试\",\"groupId\":3,\"latitude\":30.67,\"longitude\":104.06,\"name\":\"测试2\",\"params\":{},\"strike\":0} ',
        NULL, 1,
        '\r\n### Error querying database.  Cause: java.sql.SQLSyntaxErrorException: You have an error in your SQL syntax; check the manual that corresponds to your MySQL server version for the right syntax to use near \'WHERE h.del_flag = 0 AND h.code = \'HP23165\'\' at line 13\r\n### The error may exist in file [D:\\Code\\Projects\\geo_hazard_monitor\\server\\zwei-iot\\target\\classes\\mapper\\iot\\hazardPoint\\HazardPointMapper.xml]\r\n### The error may involve com.zwei.iot.hazardpoint.mapper.HazardPointMapper.checkHazardPointCodeUnique-Inline\r\n### The error occurred while setting parameters\r\n### SQL: SELECT h.id, h.code, h.name, h.group_id, h.group_name, h.longitude, h.latitude, h.strike,                h.description, h.status, h.device_count, h.del_flag, h.create_by, h.create_time,                h.update_by, h.update_time,                CASE h.status                    WHEN 1 THEN \'监测中\'                    WHEN 2 THEN \'停测中\'                    WHEN 3 THEN \'已完结\'                    ELSE \'\'                END AS status_name         FROM hazard_point h         WHERE h.del_flag = \'0\'               WHERE h.del_flag = 0 AND h.code = ?\r\n### Cause: java.sql.SQLSyntaxErrorException: You have an error in your SQL syntax; check the manual that corresponds to your MySQL server version for the right syntax to use near \'WHERE h.del_flag = 0 AND h.code = \'HP23165\'\' at line 13\n; bad SQL grammar []',
        '2026-05-21 19:50:48', 6),
       (130, '隐患点管理', 1, 'com.zwei.iot.hazardpoint.controller.HazardPointController.add()', 'POST', 1, 'admin',
        '研发部门', '/api/v1/hazard-points', '192.168.51.48', '内网IP',
        '{\"code\":\"HP23165\",\"description\":\"测试\",\"groupId\":3,\"latitude\":30.67,\"longitude\":104.06,\"name\":\"测试2\",\"params\":{},\"strike\":0} ',
        NULL, 1,
        '\r\n### Error querying database.  Cause: java.sql.SQLSyntaxErrorException: You have an error in your SQL syntax; check the manual that corresponds to your MySQL server version for the right syntax to use near \'WHERE h.del_flag = 0 AND h.code = \'HP23165\'\' at line 13\r\n### The error may exist in file [D:\\Code\\Projects\\geo_hazard_monitor\\server\\zwei-iot\\target\\classes\\mapper\\iot\\hazardPoint\\HazardPointMapper.xml]\r\n### The error may involve com.zwei.iot.hazardpoint.mapper.HazardPointMapper.checkHazardPointCodeUnique-Inline\r\n### The error occurred while setting parameters\r\n### SQL: SELECT h.id, h.code, h.name, h.group_id, h.group_name, h.longitude, h.latitude, h.strike,                h.description, h.status, h.device_count, h.del_flag, h.create_by, h.create_time,                h.update_by, h.update_time,                CASE h.status                    WHEN 1 THEN \'监测中\'                    WHEN 2 THEN \'停测中\'                    WHEN 3 THEN \'已完结\'                    ELSE \'\'                END AS status_name         FROM hazard_point h         WHERE h.del_flag = \'0\'               WHERE h.del_flag = 0 AND h.code = ?\r\n### Cause: java.sql.SQLSyntaxErrorException: You have an error in your SQL syntax; check the manual that corresponds to your MySQL server version for the right syntax to use near \'WHERE h.del_flag = 0 AND h.code = \'HP23165\'\' at line 13\n; bad SQL grammar []',
        '2026-05-21 19:50:49', 7),
       (131, '隐患点管理', 3, 'com.zwei.iot.hazardpoint.controller.HazardPointController.remove()', 'DELETE', 1,
        'admin', '研发部门', '/api/v1/hazard-points/12', '192.168.51.48', '内网IP', '12 ',
        '{\"msg\":\"操作成功\",\"code\":200,\"timestamp\":1779364464644}', 0, NULL, '2026-05-21 19:54:24', 150),
       (132, '隐患点管理', 1, 'com.zwei.iot.hazardpoint.controller.HazardPointController.add()', 'POST', 1, 'admin',
        '研发部门', '/api/v1/hazard-points', '192.168.51.48', '内网IP',
        ...
        '2026-05-21 19:54:35', 7),
       (133, '隐患点管理', 1, 'com.zwei.iot.hazardpoint.controller.HazardPointController.add()', 'POST', 1, 'admin',
        '研发部门', '/api/v1/hazard-points', '192.168.51.48', '内网IP',
        ...
        '2026-05-21 19:55:34', 4),
       (134, '隐患点管理', 1, 'com.zwei.iot.hazardpoint.controller.HazardPointController.add()', 'POST', 1, 'admin',
        '研发部门', '/api/v1/hazard-points', '192.168.51.48', '内网IP',
        '{\"code\":\"HP222\",\"description\":\"dv\",\"groupId\":6,\"latitude\":30.67,\"longitude\":104.06,\"name\":\"2222\",\"params\":{},\"strike\":2} ',
        NULL, 1,
        '\r\n### Error querying database.  Cause: java.sql.SQLSyntaxErrorException: You have an error in your SQL syntax; check the manual that corresponds to your MySQL server version for the right syntax to use near \'WHERE h.del_flag = 0 AND h.code = \'HP222\'\' at line 13\r\n### The error may exist in file [D:\\Code\\Projects\\geo_hazard_monitor\\server\\zwei-iot\\target\\classes\\mapper\\iot\\hazardPoint\\HazardPointMapper.xml]\r\n### The error may involve com.zwei.iot.hazardpoint.mapper.HazardPointMapper.checkHazardPointCodeUnique-Inline\r\n### The error occurred while setting parameters\r\n### SQL: SELECT h.id, h.code, h.name, h.group_id, h.group_name, h.longitude, h.latitude, h.strike,                h.description, h.status, h.device_count, h.del_flag, h.create_by, h.create_time,                h.update_by, h.update_time,                CASE h.status                    WHEN 1 THEN \'监测中\'                    WHEN 2 THEN \'停测中\'                    WHEN 3 THEN \'已完结\'                    ELSE \'\'                END AS status_name         FROM hazard_point h         WHERE h.del_flag = \'0\'               WHERE h.del_flag = 0 AND h.code = ?\r\n### Cause: java.sql.SQLSyntaxErrorException: You have an error in your SQL syntax; check the manual that corresponds to your MySQL server version for the right syntax to use near \'WHERE h.del_flag = 0 AND h.code = \'HP222\'\' at line 13\n; bad SQL grammar []',
        '2026-05-21 19:55:40', 6),
       (135, '监测类型', 3, 'com.zwei.iot.monitor.controller.MonitorTypeController.remove()', 'DELETE', 1, 'admin',
        '研发部门', '/api/v1/monitor-types/1', '192.168.51.48', '内网IP', '1 ',
        '{\"msg\":\"操作成功\",\"code\":200,\"timestamp\":1779366075392}', 0, NULL, '2026-05-21 20:21:15', 43),
       (136, '监测类型', 1, 'com.zwei.iot.monitor.controller.MonitorTypeController.add()', 'POST', 1, 'admin',
        '研发部门', '/api/v1/monitor-types', '192.168.51.48', '内网IP',
        ...
        '{\"msg\":\"操作成功\",\"code\":200,\"data\":9,\"timestamp\":1779366481905}', 0, NULL, '2026-05-21 20:28:01',
        94),
       (137, '监测类型', 2, 'com.zwei.iot.monitor.controller.MonitorTypeController.edit()', 'PUT', 1, 'admin',
        '研发部门', '/api/v1/monitor-types/9', '192.168.51.48', '内网IP',
        '9 {\"description\":\"\",\"deviceType\":1,\"icon\":\"/jc-icon/green/dw_green.png\",\"id\":9,\"name\":\"测试\",\"params\":{},\"sortOrder\":0,\"status\":1,\"updateBy\":\"admin\"} ',
        '{\"msg\":\"操作成功\",\"code\":200,\"timestamp\":1779367159081}', 0, NULL, '2026-05-21 20:39:19', 21),
       (138, '监测类型', 2, 'com.zwei.iot.monitor.controller.MonitorTypeController.edit()', 'PUT', 1, 'admin',
        '研发部门', '/api/v1/monitor-types/7', '192.168.51.48', '内网IP',
        '7 {\"description\":\"\",\"deviceType\":2,\"icon\":\"\",\"id\":7,\"name\":\"地温监测\",\"params\":{},\"sortOrder\":0,\"status\":1,\"updateBy\":\"admin\"} ',
        '{\"msg\":\"操作成功\",\"code\":200,\"timestamp\":1779367944963}', 0, NULL, '2026-05-21 20:52:24', 18),
       (139, '监测类型', 2, 'com.zwei.iot.monitor.controller.MonitorTypeController.edit()', 'PUT', 1, 'admin',
        '研发部门', '/api/v1/monitor-types/7', '192.168.51.48', '内网IP',
        '7 {\"description\":\"\",\"deviceType\":2,\"icon\":\"/green/tl_green.png\",\"id\":7,\"name\":\"地温监测\",\"params\":{},\"sortOrder\":0,\"status\":1,\"updateBy\":\"admin\"} ',
        '{\"msg\":\"操作成功\",\"code\":200,\"timestamp\":1779369354190}', 0, NULL, '2026-05-21 21:15:54', 30),
       (140, '监测类型', 2, 'com.zwei.iot.monitor.controller.MonitorTypeController.edit()', 'PUT', 1, 'admin',
        '研发部门', '/api/v1/monitor-types/5', '192.168.51.48', '内网IP',
        '5 {\"description\":\"\",\"deviceType\":2,\"icon\":\"/green/ky_green.png\",\"id\":5,\"name\":\"裂缝监测\",\"params\":{},\"sortOrder\":0,\"status\":1,\"updateBy\":\"admin\"} ',
        '{\"msg\":\"操作成功\",\"code\":200,\"timestamp\":1779369594325}', 0, NULL, '2026-05-21 21:19:54', 11),
       (141, '监测类型', 2, 'com.zwei.iot.monitor.controller.MonitorTypeController.edit()', 'PUT', 1, 'admin',
        '研发部门', '/api/v1/monitor-types/7', '192.168.51.64', '内网IP',
        '7 {\"description\":\"\",\"deviceType\":2,\"icon\":\"/jc-icon/green/jsd_green.png\",\"id\":7,\"name\":\"地温监测\",\"params\":{},\"sortOrder\":0,\"status\":1,\"updateBy\":\"admin\"} ',
        '{\"msg\":\"操作成功\",\"code\":200,\"timestamp\":1779418219782}', 0, NULL, '2026-05-22 10:50:19', 46),
       (142, '监测类型', 2, 'com.zwei.iot.monitor.controller.MonitorTypeController.edit()', 'PUT', 1, 'admin',
        '研发部门', '/api/v1/monitor-types/5', '192.168.51.64', '内网IP',
        '5 {\"description\":\"\",\"deviceType\":2,\"icon\":\"/jc-icon/green/jsd_green.png\",\"id\":5,\"name\":\"裂缝监测\",\"params\":{},\"sortOrder\":0,\"status\":1,\"updateBy\":\"admin\"} ',
        '{\"msg\":\"操作成功\",\"code\":200,\"timestamp\":1779418224254}', 0, NULL, '2026-05-22 10:50:24', 20),
       (143, '监测类型', 2, 'com.zwei.iot.monitor.controller.MonitorTypeController.edit()', 'PUT', 1, 'admin',
        '研发部门', '/api/v1/monitor-types/3', '192.168.51.64', '内网IP',
        ...
        '{\"msg\":\"操作成功\",\"code\":200,\"timestamp\":1779418398977}', 0, NULL, '2026-05-22 10:53:18', 15),
       (144, '监测类型', 2, 'com.zwei.iot.monitor.controller.MonitorTypeController.edit()', 'PUT', 1, 'admin',
        '研发部门', '/api/v1/monitor-types/4', '192.168.51.64', '内网IP',
        ...
        '{\"msg\":\"操作成功\",\"code\":200,\"timestamp\":1779418408839}', 0, NULL, '2026-05-22 10:53:28', 12),
       (145, '监测类型', 2, 'com.zwei.iot.monitor.controller.MonitorTypeController.edit()', 'PUT', 1, 'admin',
        '研发部门', '/api/v1/monitor-types/2', '192.168.51.64', '内网IP',
        '2 {\"description\":\"\",\"deviceType\":2,\"icon\":\"/jc-icongreen/sc_green.png\",\"id\":2,\"name\":\"位移监测\",\"params\":{},\"sortOrder\":0,\"status\":1,\"updateBy\":\"admin\"} ',
        '{\"msg\":\"操作成功\",\"code\":200,\"timestamp\":1779418421471}', 0, NULL, '2026-05-22 10:53:41', 19),
       (146, '监测类型', 2, 'com.zwei.iot.monitor.controller.MonitorTypeController.edit()', 'PUT', 1, 'admin',
        '研发部门', '/api/v1/monitor-types/7', '192.168.51.64', '内网IP',
        '7 {\"description\":\"\",\"deviceType\":2,\"icon\":\"/jc-icongreen/sc_green.png\",\"id\":7,\"name\":\"地温监测\",\"params\":{},\"sortOrder\":0,\"status\":1,\"updateBy\":\"admin\"} ',
        '{\"msg\":\"操作成功\",\"code\":200,\"timestamp\":1779418427566}', 0, NULL, '2026-05-22 10:53:47', 21),
       (147, '监测类型', 2, 'com.zwei.iot.monitor.controller.MonitorTypeController.edit()', 'PUT', 1, 'admin',
        '研发部门', '/api/v1/monitor-types/7', '192.168.51.64', '内网IP',
        ...
        '{\"msg\":\"操作成功\",\"code\":200,\"timestamp\":1779418566506}', 0, NULL, '2026-05-22 10:56:06', 13),
       (148, '监测类型', 2, 'com.zwei.iot.monitor.controller.MonitorTypeController.edit()', 'PUT', 1, 'admin',
        '研发部门', '/api/v1/monitor-types/7', '192.168.51.64', '内网IP',
        ...
        '{\"msg\":\"操作成功\",\"code\":200,\"timestamp\":1779418576541}', 0, NULL, '2026-05-22 10:56:16', 13),
       (149, '监测类型', 2, 'com.zwei.iot.monitor.controller.MonitorTypeController.edit()', 'PUT', 1, 'admin',
        '研发部门', '/api/v1/monitor-types/3', '192.168.51.64', '内网IP',
        ...
        '{\"msg\":\"操作成功\",\"code\":200,\"timestamp\":1779418582807}', 0, NULL, '2026-05-22 10:56:22', 12),
       (150, '监测类型', 2, 'com.zwei.iot.monitor.controller.MonitorTypeController.edit()', 'PUT', 1, 'admin',
        '研发部门', '/api/v1/monitor-types/4', '192.168.51.64', '内网IP',
        ...
        '{\"msg\":\"操作成功\",\"code\":200,\"timestamp\":1779418589145}', 0, NULL, '2026-05-22 10:56:29', 16),
       (151, '监测类型', 2, 'com.zwei.iot.monitor.controller.MonitorTypeController.edit()', 'PUT', 1, 'admin',
        '研发部门', '/api/v1/monitor-types/2', '192.168.51.64', '内网IP',
        '2 {\"description\":\"\",\"deviceType\":2,\"icon\":\"/jc-icon/green/jsd_green.png\",\"id\":2,\"name\":\"位移监测\",\"params\":{},\"sortOrder\":0,\"status\":1,\"updateBy\":\"admin\"} ',
        '{\"msg\":\"操作成功\",\"code\":200,\"timestamp\":1779418649432}', 0, NULL, '2026-05-22 10:57:29', 13),
       (152, '监测类型', 2, 'com.zwei.iot.monitor.controller.MonitorTypeController.edit()', 'PUT', 1, 'admin',
        '研发部门', '/api/v1/monitor-types/1', '192.168.51.64', '内网IP',
        '1 {\"description\":\"\",\"deviceType\":2,\"icon\":\"/jc-icon/green/wj_green.png\",\"id\":1,\"name\":\"雨量监测\",\"params\":{},\"sortOrder\":0,\"status\":1,\"updateBy\":\"admin\"} ',
        '{\"msg\":\"操作成功\",\"code\":200,\"timestamp\":1779418656559}', 0, NULL, '2026-05-22 10:57:36', 10),
       (153, '监测类型', 2, 'com.zwei.iot.monitor.controller.MonitorTypeController.edit()', 'PUT', 1, 'admin',
        '研发部门', '/api/v1/monitor-types/9', '192.168.51.64', '内网IP',
        '9 {\"description\":\"\",\"deviceType\":1,\"icon\":\"/jc-icon/green/wj_green.png\",\"id\":9,\"name\":\"测试\",\"params\":{},\"sortOrder\":0,\"status\":1,\"updateBy\":\"admin\"} ',
        '{\"msg\":\"操作成功\",\"code\":200,\"timestamp\":1779418662376}', 0, NULL, '2026-05-22 10:57:42', 9),
       (154, '监测类型', 2, 'com.zwei.iot.monitor.controller.MonitorTypeController.edit()', 'PUT', 1, 'admin',
        '研发部门', '/api/v1/monitor-types/3', '192.168.51.64', '内网IP',
        '3 {\"description\":\"\",\"deviceType\":2,\"icon\":\"/jc-icon/green/ky_green.png\",\"id\":3,\"name\":\"温湿度监测\",\"params\":{},\"sortOrder\":0,\"status\":1,\"updateBy\":\"admin\"} ',
        '{\"msg\":\"操作成功\",\"code\":200,\"timestamp\":1779421325313}', 0, NULL, '2026-05-22 11:42:05', 52),
       (155, '监测类型', 2, 'com.zwei.iot.monitor.controller.MonitorTypeController.edit()', 'PUT', 1, 'admin',
        '研发部门', '/api/v1/monitor-types/4', '192.168.51.64', '内网IP',
        '4 {\"description\":\"\",\"deviceType\":2,\"icon\":\"/jc-icon/green/sg_green.png\",\"id\":4,\"name\":\"水位监测\",\"params\":{},\"sortOrder\":0,\"status\":1,\"updateBy\":\"admin\"} ',
        '{\"msg\":\"操作成功\",\"code\":200,\"timestamp\":1779421332515}', 0, NULL, '2026-05-22 11:42:12', 20),
       (156, '监测类型', 2, 'com.zwei.iot.monitor.controller.MonitorTypeController.edit()', 'PUT', 1, 'admin',
        '研发部门', '/api/v1/monitor-types/6', '192.168.51.64', '内网IP',
        '6 {\"description\":\"\",\"deviceType\":2,\"icon\":\"/jc-icon/green/nw_green.png\",\"id\":6,\"name\":\"倾斜监测\",\"params\":{},\"sortOrder\":0,\"status\":1,\"updateBy\":\"admin\"} ',
        '{\"msg\":\"操作成功\",\"code\":200,\"timestamp\":1779421337410}', 0, NULL, '2026-05-22 11:42:17', 21),
       (157, '监测类型', 2, 'com.zwei.iot.monitor.controller.MonitorTypeController.edit()', 'PUT', 1, 'admin',
        '研发部门', '/api/v1/monitor-types/7', '192.168.51.64', '内网IP',
        '7 {\"description\":\"\",\"deviceType\":2,\"icon\":\"/jc-icon/green/gnss_green.png\",\"id\":7,\"name\":\"地温监测\",\"params\":{},\"sortOrder\":0,\"status\":1,\"updateBy\":\"admin\"} ',
        '{\"msg\":\"操作成功\",\"code\":200,\"timestamp\":1779421344217}', 0, NULL, '2026-05-22 11:42:24', 15),
       (158, '监测类型', 2, 'com.zwei.iot.monitor.controller.MonitorTypeController.edit()', 'PUT', 1, 'admin',
        '研发部门', '/api/v1/monitor-types/8', '192.168.51.64', '内网IP',
        '8 {\"description\":\"\",\"deviceType\":2,\"icon\":\"/jc-icon/green/lf_green.png\",\"id\":8,\"name\":\"含水率监测\",\"params\":{},\"sortOrder\":0,\"status\":1,\"updateBy\":\"admin\"} ',
        '{\"msg\":\"操作成功\",\"code\":200,\"timestamp\":1779421348853}', 0, NULL, '2026-05-22 11:42:28', 21),
       (159, '监测类型', 2, 'com.zwei.iot.monitor.controller.MonitorTypeController.edit()', 'PUT', 1, 'admin',
        '研发部门', '/api/v1/monitor-types/1', '192.168.51.64', '内网IP',
        '1 {\"description\":\"\",\"deviceType\":2,\"icon\":\"/jc-icon/green/wj_green.png\",\"id\":1,\"name\":\"雨量监测\",\"params\":{},\"sortOrder\":0,\"status\":1,\"updateBy\":\"admin\"} ',
        '{\"msg\":\"操作成功\",\"code\":200,\"timestamp\":1779421681128}', 0, NULL, '2026-05-22 11:48:01', 17);
/*!40000 ALTER TABLE `sys_oper_log`
    ENABLE KEYS */;
UNLOCK TABLES;
...
VALUES (1, '超级管理员', 'admin', 1, '1', 1, 1, '0', '0', 'admin', '2026-05-08 22:05:52', '', NULL, '超级管理员'),
       ...
       (100, '监测管理员', 'MONITOR', 3, '2', 1, 1, '0', '0', 'admin', '2026-05-08 22:06:03', '', NULL,
        '监测业务管理员'),
       (101, '操作员', 'OPERATOR', 4, '3', 1, 1, '0', '0', 'admin', '2026-05-08 22:06:03', '', NULL, '普通操作员');
/*!40000 ALTER TABLE `sys_role`
    ENABLE KEYS */;
UNLOCK TABLES;
...
VALUES (1, 103, 'admin', '若依', '00', 'ry@163.com', '15888888888', '1', '',
        '$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2', '0', '0', '192.168.51.64',
        '2026-05-22 11:41:49', '2026-05-08 22:05:52', 'admin', '2026-05-08 22:05:52', '', NULL, '管理员'),
...
-- Dump completed on 2026-05-22 23:32:09
