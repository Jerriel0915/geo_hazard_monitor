...
import com.zwei.common.utils.http.UserAgentUtils;
...
public class TokenService
{
    ...
    public String createToken(LoginUser loginUser, Boolean rememberMe)
    {
        ...
        refreshToken(loginUser, rememberMe);
     ...
     * @param rememberMe 是否记住我
     */
    public void refreshToken(LoginUser loginUser, Boolean rememberMe)
    {
        loginUser.setLoginTime(System.currentTimeMillis());
        // 记住我：7天，否则使用配置的默认过期时间
        int expireMinutes = rememberMe != null && rememberMe ? 7 * 24 * 60 : expireTime;
