...
@Setter @Getter
public class MonitorCategoryUpdateRequest implements Serializable {
    ...
    public boolean hasUpdatableField() { return name != null || icon != null || sortOrder != null || status != null; }
}
